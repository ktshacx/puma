...
import { Heading, Card, CardBody, Flex, ArrowForwardIcon } from 'pulsepumaui'
  ...
  return (
    <StyledFarmStakingCard>
      <NavLink exact activeClassName="active" to="/pools" id="pool-cta">
        <CardBody>
          <Heading color="orange" size="lg">
            Stake Lydia, Joe, Yak and more
          </Heading>
          <CardMidContent color="white">Earn PULSEPUMA</CardMidContent>
