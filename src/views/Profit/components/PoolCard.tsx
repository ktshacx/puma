...
import { Button, IconButton, useModal, AddIcon, Image, Flex, Text } from 'pulsepumaui'
...
const PoolCard: React.FC<HarvestProps> = ({ pool }) => {
  ...
  return (
    ...
    <Card isActive={isCardActive} isFinished={isFinished && sousId !== 0}>
      {pool.stakingTokenName === 'IRID-PULSEPUMA' && <StyledCardAccent />}
        ...
        <StyledDetails>
          <div style={{ flex: 1 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <Image src={`/images/tokens/${stakingTokenName}.png`} width={20} height={20} alt="PULSEPUMA" />
